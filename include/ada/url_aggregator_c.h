...
/* ---- Search params bridge ------------------------------------------------ */
void* ada_parse_search_params_impl(const char* input,
                                   size_t length) ADA_NOEXCEPT;
void  ada_free_search_params_impl(void* result) ADA_NOEXCEPT;
char* ada_search_params_to_string_impl(void* result,
                                       size_t* out_length) ADA_NOEXCEPT;
size_t ada_search_params_size_impl(void* result) ADA_NOEXCEPT;
void  ada_search_params_sort_impl(void* result) ADA_NOEXCEPT;
...
bool  ada_search_params_has_value_impl(void* result, const char* key,
                                       size_t key_length, const char* value,
                                       size_t value_length) ADA_NOEXCEPT;
/* get returns NULL if not found; returned pointer into search params storage. */
const char* ada_search_params_get_impl(void* result, const char* key,
                                       size_t key_length,
                                       size_t* out_length) ADA_NOEXCEPT;
/* get_all returns a heap-allocated std::vector<std::string>*.               */
void* ada_search_params_get_all_impl(void* result, const char* key,
                                     size_t key_length) ADA_NOEXCEPT;
void* ada_search_params_get_keys_impl(void* result) ADA_NOEXCEPT;
void* ada_search_params_get_values_impl(void* result) ADA_NOEXCEPT;
void* ada_search_params_get_entries_impl(void* result) ADA_NOEXCEPT;

void   ada_free_strings_impl(void* result) ADA_NOEXCEPT;
size_t ada_strings_size_impl(void* result) ADA_NOEXCEPT;
const char* ada_strings_get_impl(void* result, size_t index,
                                 size_t* out_length) ADA_NOEXCEPT;

void   ada_free_search_params_keys_iter_impl(void* result) ADA_NOEXCEPT;
const char* ada_search_params_keys_iter_next_impl(void* result,
                                                   size_t* out_length) ADA_NOEXCEPT;
bool   ada_search_params_keys_iter_has_next_impl(void* result) ADA_NOEXCEPT;

void   ada_free_search_params_values_iter_impl(void* result) ADA_NOEXCEPT;
const char* ada_search_params_values_iter_next_impl(void* result,
                                                     size_t* out_length) ADA_NOEXCEPT;
bool   ada_search_params_values_iter_has_next_impl(void* result) ADA_NOEXCEPT;

void   ada_free_search_params_entries_iter_impl(void* result) ADA_NOEXCEPT;
void   ada_search_params_entries_iter_next_impl(void* result,
                                                 const char** key,
                                                 size_t* key_length,
                                                 const char** value,
                                                 size_t* value_length) ADA_NOEXCEPT;
bool   ada_search_params_entries_iter_has_next_impl(void* result) ADA_NOEXCEPT;

/* Version bridge. */
const char* ada_get_version_impl(void) ADA_NOEXCEPT;
void ada_get_version_components_impl(int* major, int* minor,
                                     int* revision) ADA_NOEXCEPT;
