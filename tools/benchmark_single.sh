...
find . -type f -name "*.txt" -print0 | while IFS= read -r -d $'\0' file; do
    ...
    cat "$file" | ../../build/tools/adaparse --benchmark | tail -n 2 >> ../benchmark_results
    echo "----------" >> ../benchmark_results

    echo "$file" >> ../benchmark_results_alternate
    cat "$file" | ../../build/tools/adaparse --benchmark --alternate | tail -n 2 >> ../benchmark_results_alternate
