...
struct constructor_string_parser {
  ...
  ada_really_inline void compile_component();
  ...
  size_t token_index;
  size_t token_increment;
  size_t group_depth;
  size_t hostname_ipv6_bracket_depth;
...
//
//     A constructor string parser has an associated input, a string, which must
//     be set upon creation.
//
...
//
//     A constructor string parser has an associated component start, a number,
//     initially set to 0.
//
//     A constructor string parser has an associated token index, a number,
//     initially set to 0.
//
//     A constructor string parser has an associated token increment, a number,
//     initially set to 1.
//
//     A constructor string parser has an associated group depth, a number,
//     initially set to 0.
//
//     A constructor string parser has an associated hostname IPv6 bracket
//     depth, a number, initially set to 0.
//
//     A constructor string parser has an associated protocol matches a special
//     scheme flag, a boolean, initially set to false.
//
//     A constructor string parser has an associated state, a string, initially
//     set to "init". It must be one of the following:
//
//     "init"
//     "protocol"
//     "authority"
...
constructor_string_parser::constructor_string_parser(std::u32string_view view) {
  ...
  result = urlpattern_init();
  component_start = 0;
  token_index = 0;
  token_increment = 0;
  group_depth = 0;
  hostname_ipv6_bracket_depth = 0;
  protocol_matches_special_scheme = 0;
  state = INIT;
}
...
ada_really_inline void constructor_string_parser::compile_component() {}
