...
if(EXISTS "/home/runner/work/ada/ada/build-bench/_deps/simdjson-subbuild/simdjson-populate-prefix/src/simdjson-populate-stamp/simdjson-populate-gitclone-lastrun.txt" AND EXISTS "/home/runner/work/ada/ada/build-bench/_deps/simdjson-subbuild/simdjson-populate-prefix/src/simdjson-populate-stamp/simdjson-populate-gitinfo.txt" AND
  ...
  message(VERBOSE
    ...
    "'/home/runner/work/ada/ada/build-bench/_deps/simdjson-subbuild/simdjson-populate-prefix/src/simdjson-populate-stamp/simdjson-populate-gitclone-lastrun.txt'"
  )
  return()
endif()
...
execute_process(
  COMMAND ${CMAKE_COMMAND} -E rm -rf "/home/runner/work/ada/ada/build-bench/_deps/simdjson-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
  message(FATAL_ERROR "Failed to remove directory: '/home/runner/work/ada/ada/build-bench/_deps/simdjson-src'")
endif()
...
execute_process(
  COMMAND "/usr/bin/git"
          checkout "v3.10.1" --
  WORKING_DIRECTORY "/home/runner/work/ada/ada/build-bench/_deps/simdjson-src"
  RESULT_VARIABLE error_code
  ${maybe_show_command}
)
if(error_code)
...
if(error_code)
  message(FATAL_ERROR "Failed to update submodules in: '/home/runner/work/ada/ada/build-bench/_deps/simdjson-src'")
endif()
...
if(error_code)
  message(FATAL_ERROR "Failed to copy script-last-run stamp file: '/home/runner/work/ada/ada/build-bench/_deps/simdjson-subbuild/simdjson-populate-prefix/src/simdjson-populate-stamp/simdjson-populate-gitclone-lastrun.txt'")
endif()
