...
execute_process(
  COMMAND "/usr/bin/git" --git-dir=.git show-ref "72bcabf"
  WORKING_DIRECTORY "/home/runner/work/ada/ada/build-bench/_deps/url_whatwg-src"
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/tags/")
  ...
  get_hash_for_ref("72bcabf" tag_sha error_msg)
  if(tag_sha STREQUAL head_sha)
    message(VERBOSE "Already at requested tag: 72bcabf")
    return()
  endif()
...
elseif(show_ref_output MATCHES "^[a-z0-9]+[ \\t]+refs/heads/")
  ...
  set(checkout_name "origin/72bcabf")
  ...
  elseif(tag_sha STREQUAL "")
    ...
    if(NOT can_fetch)
      message(FATAL_ERROR
        "Requested git ref \"72bcabf\" is not present locally, and not "
